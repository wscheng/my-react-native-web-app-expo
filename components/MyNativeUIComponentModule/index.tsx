...
import { requireNativeComponent, View, StyleSheet, HostComponent, StyleProp, ViewStyle } from 'react-native';
...
//  }
var RCTMyNativeUIComponent:HostComponent<{style: StyleProp<ViewStyle>}> =  requireNativeComponent('RCTMyNativeUIComponent');
